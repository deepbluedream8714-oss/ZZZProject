    ...
    agents: [
      {
        ...
        tags: ["치명타", "얼음", "메인딜러"],
        image: new URL(
          "../assets/images/charactor/빅토리아 하우스키핑/빅토리아_엘렌 조.png",
          import.meta.url
        ).href,
        ...
        skills: {
          ...
          special:
            "강력한 돌진 공격으로 적에게 큰 얼음 피해를 입히고 얼림 효과를 부여합니다.",
          ultimate:
            "궁극의 얼음 참격을 발동하여 광역 피해를 입히고 적을 동결시킵니다.",
          passive:
            "치명타 발생 시 공격 속도가 증가하며, 얼음 피해가 강화됩니다.",
        },
        build: {
        ...
        teams: {
          ...
          synergy:
            "얼음 속성 에이전트와 조합 시 속성 공명으로 얼음 저항 감소 및 피해 증가 효과를 받습니다.",
        },
        rating: {
          damage: 95,
          survival: 65,
        ...
        recommendation:
          "얼음 메인 딜러를 찾는 플레이어에게 최고의 선택입니다. 높은 투자 대비 최상급 성능을 발휘하며, 특히 보스전에서 압도적인 딜량을 자랑합니다.",
      },
      {
        id: 2,
        name: "주연",
        ...
        tags: ["에테르", "강공"],
        image: new URL(
          "../assets/images/charactor/형사특수팀/형사특수팀_주연.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["물리", "메인딜러", "기동력"],
        image: new URL(
          "../assets/images/charactor/토끼굴/토끼굴_네코미야 마나.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["화염", "메인딜러"],
        image: new URL(
          "../assets/images/charactor/오볼로스/오볼로스_11호.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["전기", "관통"],
        image: new URL(
          "../assets/images/charactor/빅토리아 하우스키핑/빅토리아_알렉산드리나.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["전기", "격파"],
        image: new URL(
          "../assets/images/charactor/토끼굴/토끼굴_엔비 데마라.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["화염", "격파"],
        image: new URL(
          "../assets/images/charactor/벨로보그 중공업/벨로보그_콜레다 벨로보그.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["감전", "이상"],
        image: new URL(
          "../assets/images/charactor/벨로보그 중공업/벨로보그_그레이스 하워드.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["화염", "방어"],
        image: new URL(
          "../assets/images/charactor/벨로보그 중공업/벨로보그_벤 비거.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["버프", "에테르", "지원"],
        image: new URL(
          "../assets/images/charactor/토끼굴/토끼굴_니콜 데마라.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["전기", "메인딜러", "감전"],
        image: new URL(
          "../assets/images/charactor/벨로보그 중공업/벨로보그_앤톤 이바노프.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["물리", "메인딜러", "치명타"],
        image: new URL(
          "../assets/images/charactor/빅토리아 하우스키핑/빅토리아_코린 위크스.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["얼음", "격파", "기절"],
        image: new URL(
          "../assets/images/charactor/빅토리아 하우스키핑/빅토리아_본 리카온.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["물리", "이상", "디버프"],
        image: new URL(
          "../assets/images/charactor/형사특수팀/형사특수팀_제인 도.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["얼음", "격파", "서브딜러"],
        image: new URL(
          "../assets/images/charactor/형사특수팀/형사특수팀_청의.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["물리", "강공", "속사"],
        image: new URL(
          "../assets/images/charactor/토끼굴/토끼굴_빌리 키드.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["얼음", "지원", "버프"],
        image: new URL(
          "../assets/images/charactor/대공동 6과/대공동 6과_소우카쿠.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["전기", "이상", "감전"],
        image: new URL(
          "../assets/images/charactor/대공동 6과/대공동 6과_츠키시로 야나기.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["얼음", "이상", "동결"],
        image: new URL(
          "../assets/images/charactor/대공동 6과/대공동 6과_호시미 미야비.png",
          import.meta.url
        ).href,
      ...
      },
      {
        ...
        tags: ["전기", "강공", "치명타"],
        image: new URL(
          "../assets/images/charactor/대공동 6과/대공동 6과_아사바 하루마사.png",
          import.meta.url
        ).href,
